%% This demo is used to reconstruct the CPS_2611 data using the HERO, MF, and SVD algorithms.
...
addpath function
%% 
load csr4_n15_noesy.mat
load mask_Nnoesy.mat
...
save('Nnoesy_recon_MF.mat','FID_Rec')
